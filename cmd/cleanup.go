...
func cleanup(cmd *cobra.Command, args []string) {
	...
	ci, err := metahelm.NewChartInstaller(nil, dl, nil, nil, k8sConfig.GroupBindings, k8sConfig.PrivilegedRepoWhitelist, k8sConfig.SecretInjections, k8sConfig.NamespaceLabels, k8sClientConfig.JWTPath, true, helmClientConfig)
	if err != nil {
