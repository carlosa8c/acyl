module github.com/Pluto-tv/acyl
...
replace (
	...
	github.com/palantir/go-githubapp => github.com/palantir/go-githubapp v0.16.0
...
replace k8s.io/kube-openapi => k8s.io/kube-openapi v0.0.0-20230530175149-33f04d5d6b58
