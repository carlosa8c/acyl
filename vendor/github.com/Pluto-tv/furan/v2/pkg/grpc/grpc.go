...
import (
	...
	"github.com/Pluto-tv/furan/v2/pkg/config"
	"github.com/Pluto-tv/furan/v2/pkg/datalayer"
...
func (gr *Server) StartBuild(ctx context.Context, req *furanrpc.BuildRequest) (*furanrpc.BuildRequestResponse, error) {
	...
	dockerfileName := ""
	if req.GetBuild().DockerfileName != "" {
		dockerfileName = req.GetBuild().DockerfileName
	}
