...
type GraphObject interface {
	// Name : the unique name for the object
	Name() string
	// String : the pretty-printed string for the object. Can be one of the following:
	...
	//  - an HTML string (<...>)
	String() string
	// Dependencies : names of dependencies, in any order
	Dependencies() []string
}
